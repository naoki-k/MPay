...
RSpec.describe Users::PersonalsController, type: :controller do
  describe "#new" do
    before { get :new }
  ...
  describe "#create" do
    context "when register success" do
      ...
      it :aggregate_failures do
        expect {
          post :create, params: { personal_user: params }
    ...
    context "when register failed" do
      let(:params) { attributes_for(:personal_user, :with_confirmation, email: nil) }
